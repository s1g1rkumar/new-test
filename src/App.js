...
import quadratic from  "./images/curve.png";
import undo from "./images/undo.png";
import snap from  "./images/camera.png";
...
function App() {
  ...
  try {
    ...
    function init() {
      ...
      showWhiteboard();
      // if (initiator) setTimeout(startRecording, 1000); todo: check later
    }
    ...
    designer.icons = {
      pencil: "http://localhost/loot-learn-delivery/images/pencil.png",
      marker: "http://localhost/loot-learn-delivery/images/marker.png",
      eraser: "http://localhost/loot-learn-delivery/images/eraser.png",
      text: "http://localhost/loot-learn-delivery/images/text.png",
      line: "http://localhost/loot-learn-delivery/images/line.png",
      arrow: "http://localhost/loot-learn-delivery/images/arrow.png",
      rectangle: "http://localhost/loot-learn-delivery/images/rectangle.png",
      quadratic: "http://localhost/loot-learn-delivery/images/curve.png",
      undo: "http://localhost/loot-learn-delivery/images/undo.png",
      snap: "http://localhost/loot-learn-delivery/images/camera.png",
      clear: "http://localhost/loot-learn-delivery/images/clear.png",
    };
    ...
    <div className="App">
      <div>
        ...
        <div className="chat_panel">
          <div className="chat_box">
            <div className="chat_header">
              Messages
              <i className="fas fa-times close_option"></i>
            </div>
        ...
        <div className="callOptions">
          ...
          <button className="btn btn-danger" title="Hangup" id="hangup">
            {" "}
